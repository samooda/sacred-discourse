    ...
    <main className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-16">
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <button
            type="button"
            className="w-full py-2.5 rounded-lg text-sm font-medium border transition-colors text-gray-400 hover:text-white hover:border-gray-500 flex items-center justify-center gap-2"
